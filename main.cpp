...
int main(int argc, char* argv[]) {
	...
	// int step_to_nonuniform = atoi(argv[5]); // number of MC steps after which non-uniform temperature field is applied.
...
char file2[]="out";
		...
		init_cycles = MMSP::generate<2>(grid, 0, nthreads,file2);
